...
contract Calculadora {
    ...
    // External Funcions
    // palabra (function) + nomre + argumentos + visibilidad + modificadores + valor devuelto
    ...
    function substraction(uint256 num1_, uint256 num2_) public returns(uint256 resultado_) {
        resultado_ = subtration_logic(num1_, num2_);
    ...
    function subtration_logic(uint256 num1_, uint256 num2_) internal pure returns(uint256 resultado_) {
        resultado_ = num1_ - num2_; 
    }
